...
# AUQI AUIQ AQUIUAQIUAIQUIAUQIUAIUQAQ

Accuracy of the forecasts should be
compared. (lets also use conf inter (see code below))

Discussion should include the model choice.

```{r}
# Example for 95% PI
inside_95 <- ts_test >= arima_forecast$lower[,2] & ts_test <= arima_forecast$upper[,2]
coverage_95 <- mean(inside_95)

width_95 <- arima_forecast$upper[,2] - arima_forecast$lower[,2]
